...
import './l.css';
import Users from '../../comp/LeaderBoard/FortniteUser';
...
const Leaderboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${BASE_URL}/user/api/fortniteleaderboard`);
    ...
    return (
        ...
        <span class="block text-gray-400">${driver.collegeName}</span>`
                    ...
                    />
                                ...
                                <td className="gap p-4 text-right font-semibold"><span>+{driver.tempPoints}</span></td>
                            </tr>
