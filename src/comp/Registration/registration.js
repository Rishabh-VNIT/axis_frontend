                ...
                <div className="form-group">
                  ...
                  <div className="relative mt-2">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-[4.5rem] pr-3 py-2 appearance-none active:bg-white outline-none border focus:border-gray-800 shadow-sm rounded-lg text-black"
                    />
                  </div>
                </div>
        ...
        <div className="absolute z-10 mt-1 w-full bg-white border border-gray-300 rounded-lg shadow-lg">
          {options.map((option) => (
            <button
              key={option}
              type="button"
              className="block w-full px-4 py-2 text-left text-gray-800 hover:bg-gray-300 focus:outline-none rounded-lg"
